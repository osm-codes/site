...
/*
$g = new Geohash();
echo $g->encode(17.38000000, 78.42000000),"\n";
echo $g->encode(17.38000000, 78.42000000, 7),"\n";
echo $g->encode(17.38000000, 78.42000000, 3),"\n";

$coordinates = $g->decode("tepfb");
echo "\nlatitude : " . $coordinates[0] . ",  longitude : " . $coordinates[1],"\n";

$coordinates = $g->decode("tepfb",7);
echo "\nlatitude : " . $coordinates[0] . ",  longitude : " . $coordinates[1],"\n";

$coordinates = $g->decode("tepfb",3);
echo "\nlatitude : " . $coordinates[0] . ",  longitude : " . $coordinates[1],"\n";
